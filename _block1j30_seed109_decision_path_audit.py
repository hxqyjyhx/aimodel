"""
Block 1J30 -- Seed 109 Decision-Path Audit for Signed Memory.

Patched from 1J29 with decision-path logging and audit diagnostics.
Traces exactly where the signed memory signal fails to affect final probe/action selection.
All 1J24b/1J28/1J29 validated fixes preserved.
...
print("=" * 70)
print("Block 1J30 -- Seed 109 Decision-Path Audit for Signed Memory")
...
# =============================================================================
# 9. Decision-Path Audit Diagnostics
# =============================================================================
print("\n[8/12] Computing Decision-Path Audit Diagnostics...")
...
# For 1J30, we need to extract these from the memory/policy objects.
...
json_path = os.path.join(CURRENT_DIR, "runs",
    "block1j30_seed109_decision_path_audit.json")
...
md_lines = []
md_lines.append("# Block 1J30 -- Seed 109 Decision-Path Audit for Signed Memory")
md_lines.append("")
...
md_lines.append(f"block_id=1J30")
md_lines.append(f"seed={SMOKE_SEED}")
...
md_path = os.path.join(CURRENT_DIR, "protocols",
    "block1j30_seed109_decision_path_audit.md")
