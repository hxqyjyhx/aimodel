...
Patched from 1J24 with four fixes:
  Fix 1: Shared episode positions across all variants
  Fix 2: True online stepwise permuted controls (permute at decision time)
  Fix 3: Deterministic permutation seed (hashlib.md5)
  Fix 4: Leakage flags from explicit per-decision fields
...
Variants:
  ...
  C_signed_sum_online_permuted_repeat_00..19 -- Online stepwise permuted (20 repeats)
  C_signed_max_abs_online_permuted_repeat_00..19 -- Online stepwise permuted (20 repeats)
...
parser.add_argument("--n-perm-repeats", type=int, default=20, help="Permutation repeats (default: 20)")
parser.add_argument("--output-suffix", type=str, default="seed101", help="Suffix for output filenames")
...
print("=" * 70)
print("Block 1J24b -- Control-Clean Online Signed Memory Validation")
...
out_json_path = os.path.join(CURRENT_DIR, "runs",
    f"block1j24b_control_clean_online_signed_memory_{args.output_suffix}.json")
...
md_lines = []
md_lines.append("# Block 1J24b -- Control-Clean Online Signed Memory Validation")
md_lines.append("")
...
md_lines.append(f"block_id=1J24b")
...
out_md_path = os.path.join(CURRENT_DIR, "protocols",
    f"block1j24b_control_clean_online_signed_memory_{args.output_suffix}.md")
